...
- переключиться на ту **куда** вливаем
...
Для того, чтобы переключиться между ветками нужно использовать команду:
...
При этом VSCode предложит какое изменение следует сохранить (входящее, существующее или оба варианта).

### Удаление ветки

Для того, чтобы удалить ветку, которая больше не нужна, например, после слияния, нужно использовать команду:
